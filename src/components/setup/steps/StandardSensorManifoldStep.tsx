      ...
      <div className="sensor-setup-step-container sensor-standard-manifold-intro">
        ...
        <div className="sensor-setup-step-title-section">
          ...
          <p className="sensor-setup-step-subtitle">
            {isWifi ? (
              <>
                Step 3 of 5: prep pipe ends, solvent-weld the Transparent T manifold, allow the cement to cure, and leak-test—same procedure as the AC Drain Wiz Mini setup guide (step 2).
              </>
            ) : (
              <>
                Step 2 of 2: prep pipe ends, solvent-weld the Transparent T manifold, allow the cement to cure, and leak-test—same procedure as the AC Drain Wiz Mini setup guide (step 2).
              </>
            )}
          </p>
