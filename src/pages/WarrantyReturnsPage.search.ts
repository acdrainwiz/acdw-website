...
export const PAGE_SEARCH_META: PageSearchMeta = {
  ...
  body:
    'Warranty coverage, return policy for Mini web orders and distributor purchases, how to file a claim, and manufacturer warranty information for AC Drain Wiz products.',
