...
export function PropertyManagerCatalogPage() {
  ...
  const maxOnlineQuantity = selectedProduct === 'mini' ? 999999 : 500
                  ...
                  <div className="hvac-pro-product-pricing-info">
                    ...
                    {product.id === 'mini' ? (
                      <div className="hvac-pro-product-savings">
                        <span className="hvac-pro-product-savings-amount">Online MSRP</span>
                      </div>
                    ) : (
                      <div className="hvac-pro-product-savings">
          ...
          <div className="hvac-pro-quantity-section">
            ...
            <div className="hvac-pro-quantity-input-wrapper">
              ...
              <input
                type="number"
                min="1"
                max={maxOnlineQuantity}
                value={quantity}
                onChange={(e) => {
                  const val = parseInt(e.target.value) || 1
                  setQuantity(Math.max(1, Math.min(maxOnlineQuantity, val)))
                  setCheckoutError(null)
                }}
