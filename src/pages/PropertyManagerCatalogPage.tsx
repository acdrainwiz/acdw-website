...
export function PropertyManagerCatalogPage() {
  ...
  const pricingTable = getProductPricingTableForRole(selectedProduct, 'property_manager')
                ...
                <div key={product.id} className="hvac-pro-product-button-wrapper">
                  <button
                    onClick={() => {
                      ...
                      if (product.id !== 'mini' && quantity > 500) setQuantity(500)
                    }}
