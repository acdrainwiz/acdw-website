...
export function PropertyManagerCatalogPage() {
  ...
  const productMaxQuantity = selectedProduct === 'mini' ? 999999 : 500
                ...
                <div key={product.id} className="hvac-pro-product-button-wrapper">
                  <button
                    onClick={() => {
                      ...
                      setQuantity((current) => product.id === 'mini' ? current : Math.min(500, current))
            ...
            <div className="hvac-pro-quantity-input-wrapper">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setQuantity(Math.max(1, Math.min(productMaxQuantity, val)))
                  setCheckoutError(null)
                }}
