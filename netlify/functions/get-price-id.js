...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Quantity ceiling. Mini is sold online at flat list price for every role.
    // Contractor / property-manager pricing tiers for Sensor and Bundle top out
    // at 500 units; above that we route to sales for a custom volume quote.
