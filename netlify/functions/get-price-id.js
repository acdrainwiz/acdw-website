...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Quantity ceiling.
    // Mini is sold at MSRP for every role, so it can use the online Stripe ceiling.
    // Contractor / property-manager pricing tiers for Sensor and Bundle top out at
    // 500 units; above that we route to sales for a custom volume quote.
