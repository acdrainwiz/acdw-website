...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Quantity ceiling.
    // Contractor / property-manager Sensor and Bundle tiers top out at 500 units.
    // Mini is sold online at flat MSRP for every role, so it can use Stripe's
    // per-line-item max just like homeowner checkout.
