  ...
  if (formType.startsWith('contact-')) {
    ...
    switch (formType) {
      ...
      case 'complimentary-mini-request': {
        const expectedAccessToken = process.env.COMPLIMENTARY_MINI_ACCESS_TOKEN || process.env.VITE_COMPLIMENTARY_MINI_ACCESS_TOKEN || ''
    ...
    try {
      ...
      return {
        ...
        body: JSON.stringify({
          ...
          message: 'We could not process your submission right now. Please try again later.',
        }),
      }
    }
